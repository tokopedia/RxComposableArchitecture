...
//}
//
//public func diffOld(_ first: String, _ second: String, _ mode: DiffMode = .full) -> String? {
//    struct Difference {
//        enum Which {
//            case both
//            case first
...
//        switch mode {
//        case .full:
//            return unfilteredDifferences
//        case .distinct:
//            return unfilteredDifferences.filter { $0.which != .both }
//        }
//    }()
//
