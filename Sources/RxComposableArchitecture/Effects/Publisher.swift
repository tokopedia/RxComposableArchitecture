...
extension EffectPublisher {
  ...
  @available(
    iOS, deprecated: 9999.0, message: "Use the async version of 'Effect.run', instead."
  )
  @available(
    macOS, deprecated: 9999.0, message: "Use the async version of 'Effect.run', instead."
  )
  @available(
    tvOS, deprecated: 9999.0, message: "Use the async version of 'Effect.run', instead."
  )
  @available(
