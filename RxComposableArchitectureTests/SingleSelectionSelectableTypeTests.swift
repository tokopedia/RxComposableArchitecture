...
internal final class SingleSelectionSelectableTypeTests: XCTestCase {
    ...
    internal func test_initNoSelection() {
        ...
        let target = State(items: .init(initialItems))
    ...
    internal func test_initWithSelection() {
        ...
        let target = State(items: SingleSelection<Item>(initialItems))
    ...
    internal func test_initWithSelection_thenChangeSelection() {
        ...
        var target = State(items: SingleSelection<Item>(initialItems))
